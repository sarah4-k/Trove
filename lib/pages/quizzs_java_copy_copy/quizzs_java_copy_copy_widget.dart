...
import 'quizzs_java_copy_copy_model.dart';
export 'quizzs_java_copy_copy_model.dart';

class QuizzsJavaCopyCopyWidget extends StatefulWidget {
  const QuizzsJavaCopyCopyWidget({
    super.key,
    this.quizRef,
...
class _QuizzsJavaCopyCopyWidgetState extends State<QuizzsJavaCopyCopyWidget> {
  late QuizzsJavaCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizzsJavaCopyCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        int quizzsJavaCopyCopyCount = snapshot.data!;
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return QuizOptionWidget(
                                                              key: Key(
                                                                  'Keyizq_${pageViewIndex}_of_${pageViewQuizzesRecordList.length}'),
                                                              questionNum: 'A',
                                                              questionName:
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return QuizOptionWidget(
                                                              key: Key(
                                                                  'Key97v_${pageViewIndex}_of_${pageViewQuizzesRecordList.length}'),
                                                              questionNum: 'B',
                                                              questionName:
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return QuizOptionWidget(
                                                              key: Key(
                                                                  'Keyf8g_${pageViewIndex}_of_${pageViewQuizzesRecordList.length}'),
                                                              questionNum: 'C',
                                                              questionName:
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return QuizOptionWidget(
                                                              key: Key(
                                                                  'Key4xt_${pageViewIndex}_of_${pageViewQuizzesRecordList.length}'),
                                                              questionNum: 'D',
                                                              questionName:
